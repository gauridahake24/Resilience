...
class _RescheduleWidgetState extends State<RescheduleWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RescheduleModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<AppointmentRecord>(
      stream: AppointmentRecord.getDocument(widget.appointmentref!),
      builder: (context, snapshot) {
        ...
        final rescheduleAppointmentRecord = snapshot.data!;
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  rescheduleAppointmentRecord.patName!,
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      10.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    rescheduleAppointmentRecord.patientId!,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Poppins',
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    final appointmentUpdateData =
                                      ...
                                      appointmentDateTime: _model.datePicked,
                                    );
                                    await rescheduleAppointmentRecord.reference
