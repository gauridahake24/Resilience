...
import 'visitedpatients_model.dart';
export 'visitedpatients_model.dart';

class VisitedpatientsWidget extends StatefulWidget {
  const VisitedpatientsWidget({Key? key}) : super(key: key);

  @override
  _VisitedpatientsWidgetState createState() => _VisitedpatientsWidgetState();
}

class _VisitedpatientsWidgetState extends State<VisitedpatientsWidget>
    with TickerProviderStateMixin {
  late VisitedpatientsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VisitedpatientsModel());
