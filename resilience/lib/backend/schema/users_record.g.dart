    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'display_name':
          ...
          break;
        case 'isDoctor':
          result.isDoctor = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool?;
          break;
        case 'isPatient':
          result.isPatient = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool?;
          break;
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  bool? _isDoctor;
  bool? get isDoctor => _$this._isDoctor;
  set isDoctor(bool? isDoctor) => _$this._isDoctor = isDoctor;

  bool? _isPatient;
  bool? get isPatient => _$this._isPatient;
  set isPatient(bool? isPatient) => _$this._isPatient = isPatient;
  ...
  UsersRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _isDoctor = $v.isDoctor;
      _isPatient = $v.isPatient;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
