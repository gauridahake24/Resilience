...
import 'past_appointments_model.dart';
export 'past_appointments_model.dart';

class PastAppointmentsWidget extends StatefulWidget {
  const PastAppointmentsWidget({Key? key}) : super(key: key);
...
class _PastAppointmentsWidgetState extends State<PastAppointmentsWidget>
  ...
  late PastAppointmentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PastAppointmentsModel());
